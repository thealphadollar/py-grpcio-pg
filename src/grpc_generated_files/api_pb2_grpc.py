...
from grpc_generated_files import api_pb2 as api__pb2


class ApiStub(object):
    """option python_package = "timus.grpc";
...
class Api(object):
    ...
    def ApiEndpoint(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/Api/ApiEndpoint',
